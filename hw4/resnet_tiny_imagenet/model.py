...
class Block(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1):
        ...
        self.block1 = nn.Sequential(
            nn.Conv2d(in_channels, out_channels, kernel_size=(3, 3), padding=1, stride=stride, bias=False),
...
class BottleneckBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1):
        ...
        self.block1 = nn.Sequential(
            ...
            nn.BatchNorm2d(out_channels),
            nn.Conv2d(out_channels, out_channels*4, kernel_size=(1, 1), stride=1, bias=False),
...
class ResNet(nn.Module):
    def __init__(self, basic_block, num_blocks, num_class):
        ...
        self.pre_layer = nn.Sequential(
            nn.Conv2d(3, 64, kernel_size=(7, 7), padding=3, stride=1),
            nn.BatchNorm2d(64),
            nn.ReLU(),
            nn.Dropout(0.1)
        )
        ...
        self.fc = nn.Linear(128 * basic_block.expansion, num_class)
